...
if TYPE_CHECKING:
  from ..models.tile_type_50 import TileType50
...
T = TypeVar("T", bound="ModuleData50")
...
class ModuleData50:
    """ 
        Attributes:
            ...
            tiles (Union[Unset, List['TileType50']]):
     """

    zones: Union[Unset, 'Zone'] = UNSET
    tiles: Union[Unset, List['TileType50']] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for tiles_item_data in (_tiles or []):
            tiles_item = TileType50.from_dict(tiles_item_data)
        ...
        module_data_50.additional_properties = d
        return module_data_50
