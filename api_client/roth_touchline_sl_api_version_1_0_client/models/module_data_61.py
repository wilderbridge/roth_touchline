...
if TYPE_CHECKING:
  ...
  from ..models.tile_type_61 import TileType61





T = TypeVar("T", bound="ModuleData61")
...
class ModuleData61:
    """ 
        Attributes:
            ...
            tiles (Union[Unset, List['TileType61']]):
     """

    zones: Union[Unset, 'Zone'] = UNSET
    tiles: Union[Unset, List['TileType61']] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for tiles_item_data in (_tiles or []):
            tiles_item = TileType61.from_dict(tiles_item_data)
        ...
        module_data_61.additional_properties = d
        return module_data_61
