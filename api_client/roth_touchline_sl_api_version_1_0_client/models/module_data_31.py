...
if TYPE_CHECKING:
  ...
  from ..models.tile_type_31 import TileType31





T = TypeVar("T", bound="ModuleData31")
...
class ModuleData31:
    """ 
        Attributes:
            ...
            tiles (Union[Unset, List['TileType31']]):
     """

    zones: Union[Unset, 'Zone'] = UNSET
    tiles: Union[Unset, List['TileType31']] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for tiles_item_data in (_tiles or []):
            tiles_item = TileType31.from_dict(tiles_item_data)
        ...
        module_data_31.additional_properties = d
        return module_data_31
