...
if TYPE_CHECKING:
  ...
  from ..models.tile_type_250 import TileType250





T = TypeVar("T", bound="ModuleData250")
...
class ModuleData250:
    """ 
        Attributes:
            ...
            tiles (Union[Unset, List['TileType250']]):
     """

    zones: Union[Unset, 'Zone'] = UNSET
    tiles: Union[Unset, List['TileType250']] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for tiles_item_data in (_tiles or []):
            tiles_item = TileType250.from_dict(tiles_item_data)
        ...
        module_data_250.additional_properties = d
        return module_data_250
