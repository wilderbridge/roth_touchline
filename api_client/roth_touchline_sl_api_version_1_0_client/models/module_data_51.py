...
if TYPE_CHECKING:
  ...
  from ..models.tile_type_51 import TileType51





T = TypeVar("T", bound="ModuleData51")
...
class ModuleData51:
    """ 
        Attributes:
            ...
            tiles (Union[Unset, List['TileType51']]):
     """

    zones: Union[Unset, 'Zone'] = UNSET
    tiles: Union[Unset, List['TileType51']] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for tiles_item_data in (_tiles or []):
            tiles_item = TileType51.from_dict(tiles_item_data)
        ...
        module_data_51.additional_properties = d
        return module_data_51
