...
if TYPE_CHECKING:
  ...
  from ..models.tile_type_252 import TileType252





T = TypeVar("T", bound="ModuleData252")
...
class ModuleData252:
    """ 
        Attributes:
            ...
            tiles (Union[Unset, List['TileType252']]):
     """

    zones: Union[Unset, 'Zone'] = UNSET
    tiles: Union[Unset, List['TileType252']] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for tiles_item_data in (_tiles or []):
            tiles_item = TileType252.from_dict(tiles_item_data)
        ...
        module_data_252.additional_properties = d
        return module_data_252
