...
if TYPE_CHECKING:
  from ..models.tile_type_22 import TileType22
...
T = TypeVar("T", bound="ModuleData22")
...
class ModuleData22:
    """ 
        Attributes:
            ...
            tiles (Union[Unset, List['TileType22']]):
     """

    zones: Union[Unset, 'Zone'] = UNSET
    tiles: Union[Unset, List['TileType22']] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for tiles_item_data in (_tiles or []):
            tiles_item = TileType22.from_dict(tiles_item_data)
        ...
        module_data_22.additional_properties = d
        return module_data_22
