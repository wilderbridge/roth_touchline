...
if TYPE_CHECKING:
  from ..models.tile_type_2 import TileType2
...
class ModuleData2:
    """ 
        Attributes:
            ...
            tiles (Union[Unset, List['TileType2']]):
     """

    zones: Union[Unset, 'Zone'] = UNSET
    tiles: Union[Unset, List['TileType2']] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for tiles_item_data in (_tiles or []):
            tiles_item = TileType2.from_dict(tiles_item_data)
        ...
        module_data_2.additional_properties = d
        return module_data_2
