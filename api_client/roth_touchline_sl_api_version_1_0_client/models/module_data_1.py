...
if TYPE_CHECKING:
  ...
  from ..models.tile_type_1 import TileType1





T = TypeVar("T", bound="ModuleData1")
...
class ModuleData1:
    """ 
        Attributes:
            ...
            tiles (Union[Unset, List['TileType1']]):
     """

    zones: Union[Unset, 'Zone'] = UNSET
    tiles: Union[Unset, List['TileType1']] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for tiles_item_data in (_tiles or []):
            tiles_item = TileType1.from_dict(tiles_item_data)
        ...
        module_data_1.additional_properties = d
        return module_data_1
