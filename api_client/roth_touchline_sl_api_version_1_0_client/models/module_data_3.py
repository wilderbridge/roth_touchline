...
if TYPE_CHECKING:
  from ..models.tile_3 import Tile3
...
class ModuleData3:
    """ 
        Attributes:
            ...
            tiles (Union[Unset, List['Tile3']]):
     """

    zones: Union[Unset, 'Zone'] = UNSET
    tiles: Union[Unset, List['Tile3']] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for tiles_item_data in (_tiles or []):
            tiles_item = Tile3.from_dict(tiles_item_data)
        ...
        module_data_3.additional_properties = d
        return module_data_3
