...
if TYPE_CHECKING:
  ...
  from ..models.tile_type_32 import TileType32





T = TypeVar("T", bound="ModuleData32")
...
class ModuleData32:
    """ 
        Attributes:
            ...
            tiles (Union[Unset, List['TileType32']]):
     """

    zones: Union[Unset, 'Zone'] = UNSET
    tiles: Union[Unset, List['TileType32']] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for tiles_item_data in (_tiles or []):
            tiles_item = TileType32.from_dict(tiles_item_data)
        ...
        module_data_32.additional_properties = d
        return module_data_32
