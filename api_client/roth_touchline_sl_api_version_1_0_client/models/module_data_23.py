...
if TYPE_CHECKING:
  ...
  from ..models.tile_type_23 import TileType23





T = TypeVar("T", bound="ModuleData23")
...
class ModuleData23:
    """ 
        Attributes:
            ...
            tiles (Union[Unset, List['TileType23']]):
     """

    zones: Union[Unset, 'Zone'] = UNSET
    tiles: Union[Unset, List['TileType23']] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for tiles_item_data in (_tiles or []):
            tiles_item = TileType23.from_dict(tiles_item_data)
        ...
        module_data_23.additional_properties = d
        return module_data_23
