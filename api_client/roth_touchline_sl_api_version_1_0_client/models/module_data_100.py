...
if TYPE_CHECKING:
  ...
  from ..models.tile_type_100 import TileType100





T = TypeVar("T", bound="ModuleData100")
...
class ModuleData100:
    """ 
        Attributes:
            ...
            tiles (Union[Unset, List['TileType100']]):
     """

    zones: Union[Unset, 'Zone'] = UNSET
    tiles: Union[Unset, List['TileType100']] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for tiles_item_data in (_tiles or []):
            tiles_item = TileType100.from_dict(tiles_item_data)
        ...
        module_data_100.additional_properties = d
        return module_data_100
