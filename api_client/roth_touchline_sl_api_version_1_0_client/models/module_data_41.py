...
if TYPE_CHECKING:
  from ..models.tile_type_41 import TileType41
...
T = TypeVar("T", bound="ModuleData41")
...
class ModuleData41:
    """ 
        Attributes:
            ...
            tiles (Union[Unset, List['TileType41']]):
     """

    zones: Union[Unset, 'Zone'] = UNSET
    tiles: Union[Unset, List['TileType41']] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for tiles_item_data in (_tiles or []):
            tiles_item = TileType41.from_dict(tiles_item_data)
        ...
        module_data_41.additional_properties = d
        return module_data_41
