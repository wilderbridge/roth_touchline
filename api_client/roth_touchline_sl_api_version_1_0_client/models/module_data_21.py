...
if TYPE_CHECKING:
  ...
  from ..models.tile_type_21 import TileType21





T = TypeVar("T", bound="ModuleData21")
...
class ModuleData21:
    """ 
        Attributes:
            ...
            tiles (Union[Unset, List['TileType21']]):
     """

    zones: Union[Unset, 'Zone'] = UNSET
    tiles: Union[Unset, List['TileType21']] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for tiles_item_data in (_tiles or []):
            tiles_item = TileType21.from_dict(tiles_item_data)
        ...
        module_data_21.additional_properties = d
        return module_data_21
