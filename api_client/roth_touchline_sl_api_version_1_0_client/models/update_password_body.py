...
T = TypeVar("T", bound="UpdatePasswordBody")
...
class UpdatePasswordBody:
    """ 
        Attributes:
            old_password (Union[Unset, str]): Current password
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        update_password_body = cls(
            old_password=old_password,
            new_password=new_password,
        )

        update_password_body.additional_properties = d
        return update_password_body
