...
if TYPE_CHECKING:
  ...
  from ..models.tile_type_60 import TileType60





T = TypeVar("T", bound="ModuleData60")
...
class ModuleData60:
    """ 
        Attributes:
            ...
            tiles (Union[Unset, List['TileType60']]):
     """

    zones: Union[Unset, 'Zone'] = UNSET
    tiles: Union[Unset, List['TileType60']] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for tiles_item_data in (_tiles or []):
            tiles_item = TileType60.from_dict(tiles_item_data)
        ...
        module_data_60.additional_properties = d
        return module_data_60
