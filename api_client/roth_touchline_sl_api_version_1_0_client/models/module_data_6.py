...
if TYPE_CHECKING:
  from ..models.tile_type_6 import TileType6
...
class ModuleData6:
    """ 
        Attributes:
            ...
            tiles (Union[Unset, List['TileType6']]):
     """

    zones: Union[Unset, 'Zone'] = UNSET
    tiles: Union[Unset, List['TileType6']] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for tiles_item_data in (_tiles or []):
            tiles_item = TileType6.from_dict(tiles_item_data)
        ...
        module_data_6.additional_properties = d
        return module_data_6
