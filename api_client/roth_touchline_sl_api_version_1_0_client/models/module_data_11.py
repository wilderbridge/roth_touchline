...
if TYPE_CHECKING:
  from ..models.tile_type_11 import TileType11
...
T = TypeVar("T", bound="ModuleData11")
...
class ModuleData11:
    """ 
        Attributes:
            ...
            tiles (Union[Unset, List['TileType11']]):
     """

    zones: Union[Unset, 'Zone'] = UNSET
    tiles: Union[Unset, List['TileType11']] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for tiles_item_data in (_tiles or []):
            tiles_item = TileType11.from_dict(tiles_item_data)
        ...
        module_data_11.additional_properties = d
        return module_data_11
