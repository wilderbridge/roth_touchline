...
if TYPE_CHECKING:
  ...
  from ..models.tile_type_251 import TileType251





T = TypeVar("T", bound="ModuleData251")
...
class ModuleData251:
    """ 
        Attributes:
            ...
            tiles (Union[Unset, List['TileType251']]):
     """

    zones: Union[Unset, 'Zone'] = UNSET
    tiles: Union[Unset, List['TileType251']] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for tiles_item_data in (_tiles or []):
            tiles_item = TileType251.from_dict(tiles_item_data)
        ...
        module_data_251.additional_properties = d
        return module_data_251
